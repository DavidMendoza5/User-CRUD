...
api.get('/insurance-policies/:id', [middleware.verifyToken, middleware.validateData(getById, 'params'), middleware.validateId(InsurancePolicy,'params', 'id')], insurancePolicyController.getClientById);
